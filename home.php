    ...
    <header class="navbar-section">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><i class="bi bi-chat"></i> Customized. Cloud</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12 text-content">
                    <h1>Take control of your cloud experience</h1>
                    <p>Craft personalized cloud protocols to achieve your
                            vision. Enhance performance, minimize latency, and achieve peak efficiency with custom cloud
                            solutions. Our experts guide you to build, manage, and optimize your cloud journey for
                            ultimate success.
                    </p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-12 col-sm-12">
                    <p class="logo"><i class="bi bi-chat"></i> Customized Cloud</p>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <ul class="d-flex">
                        <li><a href="#">Home</a></li>
